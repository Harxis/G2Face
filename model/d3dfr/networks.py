...
def define_net_recon(net_recon, use_last_fc=False, init_path=None):
    net = ReconNetWrapper(net_recon, use_last_fc=use_last_fc, init_path=init_path)
    print(init_path)
    net.load_state_dict(torch.load(init_path,  map_location='cpu')['net_recon'])
    return net
...
class ReconNetWrapper(nn.Module):
    ...
    def __init__(self, net_recon, use_last_fc=False, init_path=None):
        ...
        #     state_dict = filter_state_dict(torch.load(init_path, map_location='cpu')['net_recon'])
